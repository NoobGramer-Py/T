...
export interface InjectionResult {
  ...
  suspicious_dlls:     string[];
  private_exec_regions:number;
  details:             string[];
}

export const detectProcessInjection = (pid: number) =>
  invoke<InjectionResult>("detect_process_injection", { pid });
...
export const getArpTable = () => invoke<ArpEntry[]>("get_arp_table");
...
export interface UsbDevice {
  ...
  vendor_id:   string;
  product_id:  string;
  device_type: "rubber_ducky" | "omg_cable" | "android" | "ios" | "unknown";
  drive_letter:string;
}

export const detectUsbDevices = () => invoke<UsbDevice[]>("detect_usb_devices");
